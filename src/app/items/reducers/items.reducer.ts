...
import { createItemSuccess, deleteItemSuccess, setItemsSuccess, updateItemSuccess } from '../actions/items.actions';
...
export const itemsReducer = createReducer(
  initialItemsState,
  on(setItemsSuccess, (state, { items }) => ({ ...state, items: items })),
